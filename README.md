...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
   ...
   Lcd_cursor(&lcd, 0,0);
   Lcd_string(&lcd, "KAVI NILAVAN DK\n");
   Lcd_cursor(&lcd, 1,2);
   Lcd_string(&lcd, "212223230103");
   HAL_Delay(500);
...
![Screenshot (95)](https://github.com/KavinilavanDK/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144870429/a659c03e-888a-4d4e-8844-f5eed358c208)
